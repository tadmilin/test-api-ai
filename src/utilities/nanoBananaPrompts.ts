...
export const NANO_BANANA_PROMPTS: Record<PhotoType, string> = {
  buffet: `ตกแต่งให้ภาพบุฟเฟ่ต์นี้ดูดีขึ้น ไม่เปลี่ยนอาหารแต่ปรับแต่งให้ดูน่ากินมากขึ้น ไม่ใส่ของอย่างอื่นในภาพ ยึดองค์ประกอบเดิมทั้งหมดไม่กลับด้านไม่เปลี่ยนแปลงภาพจนมากเกินไป เน้นความสะอาด แสงสว่างธรรมชาติ และบรรยากาศอบอุ่น`,
  ...
  dining_room: `แต่งภาพห้องอาหารนี้ให้ดูอบอุ่น ดูน่าใช้บริการ เพิ่มความสว่างแบบสมจริงธรรมชาติและบรรยากาศที่น่าประทับใจ ไม่ใส่ของอย่างอื่นในภาพ ยึดองค์ประกอบเดิมทั้งหมดไม่กลับด้าน ไม่เปลี่ยนแปลงภาพจนเกินไป ให้ดูสมจริงและเป็นธรรมชาติ`,

  bedroom: `ตกแต่งภาพนี้ให้ดูดีขึ้น ดูอบอุ่น สะอาด หรูหรา แบบโรงแรมโมเดิร์น 3-4 ดาว ปรับแสงให้สบายตาดูสวยงามแต่ไม่เปลี่ยนสีแสงจนมากเกินไป เพิ่มความนุ่มนวลของผ้าปูที่นอนที่สะอาดและเรียบร้อย แต่ยึดมุมเดิม ไม่ใส่วัตถุอื่นในภาพ ตำแหน่งเฟอร์นิเจอร์เดิมทุกอย่าง ไม่กลับด้านไม่เปลี่ยนโครงสร้างห้องไม่เปลี่ยนแปลงภาพต้นฉบับ ไม่เติมอาหารหรือของกินลงไป ให้ดูเป็นธรรมชาติสมจริง`,
  ...
  building_exterior: `ตกแต่งภาพภายนอกอาคารนี้ให้ดูดีขึ้นน่าประทับใจ สะอาด และหรูหรา ปรับแสงและสีให้สวยงาม แต่ยึดสถาปัตยกรรมและโครงสร้างเดิมทั้งหมด ให้ดูเป็นธรรมชาติสมจริง`,
