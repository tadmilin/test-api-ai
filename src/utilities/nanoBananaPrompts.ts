...
export const NANO_BANANA_PROMPTS: Record<PhotoType, string> = {
  ...
  bedroom: `ตกแต่งภาพนี้ให้ดูดีขึ้น สะอาด หรูหรา  เพิ่มความสว่างแบบสมจริงธรรมชาติแต่ไม่ปรับสีแสงเดิมในภาพ ปรับแต่งให้ดูสะอาดและเรียบร้อย แต่ยึดมุมเดิม ไม่ใส่วัตถุอื่นในภาพ ตำแหน่งเฟอร์นิเจอร์เดิมทุกอย่าง ไม่กลับด้านไม่เปลี่ยนโครงสร้างห้องไม่เปลี่ยนแปลงภาพต้นฉบับ ไม่เติมอาหารหรือของกินลงไป ให้ดูเป็นธรรมชาติสมจริง`,
  ...
  building_exterior: `ตกแต่งภาพภายนอกอาคารนี้ให้ดูดีขึ้นน่าประทับใจ สะอาด และหรูหรา ปรับแสงและสีให้สวยงาม แต่ยึดสถาปัตยกรรมและโครงสร้างเดิมทั้งหมด ให้ดูเป็นธรรมชาติสมจริง ไม่เติมวัตถุสิ่งของอื่นในภาพ`,
