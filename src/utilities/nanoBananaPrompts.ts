...
export const NANO_BANANA_PROMPTS: Record<PhotoType, string> = {
  ...
  dining_room: `แต่งภาพห้องอาหารนี้ให้ดูดีขึ้น ทำให้อาหารดูน่ากินแต่ไม่เปลี่ยนแปลงอาหาร เหมาะสำหรับห้องอาหารและไลน์บุฟเฟต์ของโรงแรม เพิ่มความสว่างเพิ่มความคมชัดแบบสมจริงธรรมชาติและปรับรายละเอียดพื้นผิวของพื้นที่ โต๊ะ และวัตถุภายในภาพเล็กน้อยให้ดูเรียบร้อยและน่าใช้บริการมากขึ้นแต่ไม่ปรับสีแสงเดิมในภาพและบรรยากาศที่น่าประทับใจ ไม่เพิ่มวัตถุ ยึดองค์ประกอบเดิมทั้งหมดไม่กลับด้านภาพ ไม่เปลี่ยนแปลงภาพจนเกินไป แต่งให้ดูสมจริงและเป็นธรรมชาติ`,
  ...
  building_exterior: `ตกแต่งภาพภายนอกอาคารรีสอร์ท/โรงแรมนี้ให้บรรยากาศดูสดใสขึ้นจนน่าประทับใจ หรูหรายิ่งใหญ่และดูสะอาด ปรับให้คมชัดและเพิ่มความสว่างแบบสมจริงธรรมชาติ ไม่เปลี่ยนโทนสีเดิม ปรับแต่งอาคารต่างๆให้ดูใหม่แต่ห้ามเปลี่ยนสีอาคาร ยึดสถาปัตยกรรมและโครงสร้างเดิมทั้งหมด ให้ดูเป็นธรรมชาติสมจริง ไม่เติมวัตถุสิ่งของอื่นในภาพไม่แก้ไขตัวอักษร ไม่เปลี่ยนแปลงภาพจนเกินไป แต่งให้ดูสมจริงและเป็นธรรมชาติ`,
