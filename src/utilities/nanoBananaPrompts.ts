...
export const NANO_BANANA_PROMPTS: Record<PhotoType, string> = {
  ...
  bedroom: `ตกแต่งภาพห้องนอนนี้ให้ดูดีขึ้น ดูอบอุ่น สะอาด หรูหรา แบบโรงแรมไทยโมเดิร์น 3-4 ดาวราคาสูง ปรับแสงให้สบายตา เพิ่มความนุ่มนวลของผ้าปูที่นอนที่สะอาดและเรียบร้อย แต่ยึดตำแหน่งเฟอร์นิเจอร์เดิมทุกอย่าง ไม่เปลี่ยนโครงสร้างห้อง ไม่เติมอาหารหรือของกินลงไป ให้ดูน่าพักผ่อนและเป็นธรรมชาติเป็นห้องนอนเท่านั้น`,

  bathroom: `ปรับปรุงภาพห้องน้ำนี้ให้ดูสะอาด สดใส และทันสมัย แบบโรงแรมไทยโมเดิร์น 3-4 ดาวราคาสูง เพิ่มความเงางามของกระจกและเซรามิก แต่เก็บตำแหน่งสุขภัณฑ์และอุปกรณ์เดิม ไม่เปลี่ยนโครงสร้าง ไม่เติมอาหารหรือของกินลงไป ให้ดูสะอาดและน่าใช้งานเป็นห้องน้ำเท่านั้น`,

  lobby: `แต่งภาพล็อบบี้นี้ให้ดูโปร่ง สว่าง สะอาด และเป็นมิตร แบบล็อบบี้โรงแรมไทยโมเดิร์น 3-4 ดาวราคาสูง เพิ่มบรรยากาศต้อนรับ แต่ยึดตำแหน่งเฟอร์นิเจอร์และของตกแต่งเดิม ไม่เปลี่ยนโครงสร้าง ไม่เติมอาหารหรือของกินลงไป ให้ดูเป็นธรรมชาติเป็นล็อบบี้เท่านั้น`,

  entrance: `ปรับภาพทางเข้านี้ให้ดูน่าประทับใจ สะอาด และเชิญชวน แบบทางเข้าโรงแรมไทยโมเดิร์น 3-4 ดาวราคาสูง เพิ่มความสว่างและบรรยากาศต้อนรับ แต่เก็บโครงสร้างและการออกแบบเดิมทั้งหมด ให้ดูเป็นธรรมชาติ`,
