...
export const NANO_BANANA_PROMPTS: Record<PhotoType, string> = {
  buffet: `ตกแต่งให้ภาพบุฟเฟ่ต์นี้ดูดีขึ้น ปรับเปลี่ยนให้ดูหรูหราน่ากินมากขึ้น ดูเป็นบุฟเฟ่โรงแรมราคาสูงแบบสไตล์โรงแรมไทย 3-4 ดาว ไม่ใส่วัตถุอื่นในภาพ ยึดองค์ประกอบเดิมมุมเดิมทั้งหมดไม่กลับด้านไม่เปลี่ยนแปลงภาพจนเวอร์เกินไป เน้นความสะอาด แสงสว่างธรรมชาติ และบรรยากาศอบอุ่น`,
  ...
  dining_room: `แต่งภาพห้องอาหารนี้ให้ดูหรูหรา อบอุ่น ดูน่าใช้บริการ ตกแต่งแบบห้องอาหารโรงแรมโมเดิร์นราคาสูง 3-4ดาว เพิ่มความสว่างและบรรยากาศที่น่าประทับใจ ยึดองค์ประกอบเดิมมุมเดิมทั้งหมดไม่กลับด้าน ไม่ใส่วัตถุอื่นในภาพ ไม่เปลี่ยนแปลงภาพจนเวอร์เกินไป ให้ดูสมจริงและเป็นธรรมชาติ`,
